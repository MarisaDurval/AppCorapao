    ...
    return (
        <View style={Estilos.container}>
            <ImageBackground source={require("./fundorose.jfif")}
              ...
              <Text style={Estilos.paragraph}>Pensou em pão, pensou CoraPão</Text>
              <Image style={Estilos.logo} source={require('./logopao.png')} />
              ...
              <View style={Estilos.button}>
                <Button onPress={() => ValidateLogin(user, password, setStatus, setActivity)} title="OK" color="#B8214C" />
              </View>
